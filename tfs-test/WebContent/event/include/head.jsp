...
<%
	...
	if (userAgent.indexOf("FACEBOOK")> 0 || userAgent.indexOf("FB")> 0 || userAgent.indexOf("KAKAOTALK")> 0 || userAgent.indexOf("KAKAOSTORY")> 0|| userAgent.indexOf("KAKAO")> 0|| userAgent.indexOf("DAUM")> 0|| userAgent.indexOf("TWITTER")> 0) {
		isInapp = true;
	}	
